...
public interface ResponsavelDAO extends JpaRepository<Responsavel, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM Tarefa entity WHERE entity.responsavel.id = :id")
  public Page<Tarefa> findTarefa(@Param(value="id") java.lang.String id,  Pageable pageable );
